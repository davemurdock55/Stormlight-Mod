...
public class ShadesbeadsBlock extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:shadesbeads")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("stormlight_mod:shadesbeads_bucket")
