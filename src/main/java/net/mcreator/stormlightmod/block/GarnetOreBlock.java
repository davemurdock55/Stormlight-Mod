...
public class GarnetOreBlock extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:garnet_ore")
	public static final Block block = null;
	public GarnetOreBlock(StormlightModModElements instance) {
		super(instance, 338);
	}
