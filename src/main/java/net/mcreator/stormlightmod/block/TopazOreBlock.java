...
public class TopazOreBlock extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:topaz_ore")
	public static final Block block = null;
	public TopazOreBlock(StormlightModModElements instance) {
		super(instance, 363);
	}
