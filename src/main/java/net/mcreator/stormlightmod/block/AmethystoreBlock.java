...
public class AmethystoreBlock extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:amethystore")
	public static final Block block = null;
	public AmethystoreBlock(StormlightModModElements instance) {
		super(instance, 153);
	}
