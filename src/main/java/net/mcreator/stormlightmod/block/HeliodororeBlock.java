...
public class HeliodororeBlock extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:heliodorore")
	public static final Block block = null;
	public HeliodororeBlock(StormlightModModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HeliodorGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("heliodorore", "heliodorore", blockAt -> {
