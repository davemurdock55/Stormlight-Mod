...
public class Shadesmar1Dimension extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:shadesmar_1")
	public static final ModDimension dimension = null;
	@ObjectHolder("stormlight_mod:shadesmar_1_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public Shadesmar1Dimension(StormlightModModElements instance) {
		super(instance, 22);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("shadesmar_1"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("stormlight_mod:shadesmar_1")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("stormlight_mod:shadesmar_1"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("stormlight_mod:shadesmar_1"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("stormlight_mod:shadesmar")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new Shadesmar1Item().setRegistryName("shadesmar_1"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("shadesmar_1_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = Shadesmar1Dimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("shadesmar_1_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "shadesmar_1_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = Shadesmar1Dimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return ShadesmarObsidianBlock.block.getDefaultState();
				}

				public BlockState getDefaultFluid() {
					return ShadesbeadsBlock.block.getDefaultState();
				}
			});
