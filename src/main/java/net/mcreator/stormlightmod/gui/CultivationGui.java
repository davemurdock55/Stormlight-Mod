...
public class CultivationGui extends StormlightModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CultivationGui(StormlightModModElements instance) {
		super(instance, 308);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("cultivation"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("I will Remeber", 52, 37, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 22, this.guiTop + 53, 130, 20, "SAY THE WORDS", e -> {
				StormlightModMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 4, this.guiTop + 4, 10, 20, "x", e -> {
		...
		if (buttonID == 0) {
			{
				...
				CultivationSprenspawningProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
