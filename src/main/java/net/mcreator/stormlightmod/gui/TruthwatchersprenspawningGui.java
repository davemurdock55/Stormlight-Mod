...
public class TruthwatchersprenspawningGui extends StormlightModModElements.ModElement {
	...
	public TruthwatchersprenspawningGui(StormlightModModElements instance) {
		super(instance, 311);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("truthwatchersprenspawning"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("stormlight_mod:textures/truthwatchersprenspawning.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("I will seek truth", 44, 37, -1);
		}
		...
		if (buttonID == 0) {
			{
				...
				TruthwatcherProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
