...
public class Stoneward1Potion extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:stoneward_1")
	public static final Effect potion = null;
	@ObjectHolder("stormlight_mod:stoneward_1")
	public static final Potion potionType = null;
	public Stoneward1Potion(StormlightModModElements instance) {
		super(instance, 176);
