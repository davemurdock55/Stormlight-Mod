...
public class Dustbringer1Potion extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:dustbringer_1")
	public static final Effect potion = null;
	@ObjectHolder("stormlight_mod:dustbringer_1")
	public static final Potion potionType = null;
	public Dustbringer1Potion(StormlightModModElements instance) {
		super(instance, 171);
