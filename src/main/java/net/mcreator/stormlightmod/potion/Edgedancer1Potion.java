...
public class Edgedancer1Potion extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:edgedancer_1")
	public static final Effect potion = null;
	public Edgedancer1Potion(StormlightModModElements instance) {
		super(instance, 172);
