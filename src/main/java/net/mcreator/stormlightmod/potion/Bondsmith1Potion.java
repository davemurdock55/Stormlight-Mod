...
public class Bondsmith1Potion extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:bondsmith_1")
	public static final Effect potion = null;
	@ObjectHolder("stormlight_mod:bondsmith_1")
	public static final Potion potionType = null;
	public Bondsmith1Potion(StormlightModModElements instance) {
		super(instance, 177);
