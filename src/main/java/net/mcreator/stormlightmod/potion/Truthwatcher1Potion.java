...
public class Truthwatcher1Potion extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:truthwatcher_1")
	public static final Effect potion = null;
	@ObjectHolder("stormlight_mod:truthwatcher_1")
	public static final Potion potionType = null;
	public Truthwatcher1Potion(StormlightModModElements instance) {
		super(instance, 173);
	...
	public static class EffectCustom extends Effect {
		...
		public void affectEntity(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
			...
			double z = entity.getPosZ();
			{
				...
				TruthwatcherPotionEffectProcedure.executeProcedure($_dependencies);
			}
		}
