...
public class DunRubyBroamItem extends StormlightModModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("dun_ruby_broam");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(
					new StringTextComponent("A small, glass sphere with a Large  piece of Ruby set inside of it. It appears to be devoid of light."));
		}
	}
}
