...
public class DunAmethystBroamItem extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:dun_amethyst_broam")
	public static final Item block = null;
	public DunAmethystBroamItem(StormlightModModElements instance) {
		super(instance, 206);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("dun_amethyst_broam");
		}
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			double z = entity.getPosZ();
			{
				...
				DunAmethystBromeItemInInventoryTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
