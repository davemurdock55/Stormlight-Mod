...
public class LashingAmplifier1Procedure extends StormlightModModElements.ModElement {
	public LashingAmplifier1Procedure(StormlightModModElements instance) {
		super(instance, 162);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure LashingAmplifier1!");
			return;
		}
