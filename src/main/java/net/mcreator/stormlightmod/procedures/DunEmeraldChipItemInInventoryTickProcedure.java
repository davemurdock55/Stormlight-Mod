...
public class DunEmeraldChipItemInInventoryTickProcedure extends StormlightModModElements.ModElement {
	public DunEmeraldChipItemInInventoryTickProcedure(StormlightModModElements instance) {
		super(instance, 107);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getWorld().isRaining())) {
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(DunEmeraldChipItem.block, (int) (1));
				((PlayerEntity) entity).inventory.clearMatchingItems(p -> _stktoremove.getItem() == p.getItem(), (int) 1);
			}
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(InfusedEmeraldChipItem.block, (int) (1));
