...
public class ElsecallerPotionEffectProcedure extends StormlightModModElements.ModElement {
	public ElsecallerPotionEffectProcedure(StormlightModModElements instance) {
		super(instance, 192);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure ElsecallerPotionEffect!");
			return;
		}
