...
public class DunZirconchiprightProcedure extends StormlightModModElements.ModElement {
	public DunZirconchiprightProcedure(StormlightModModElements instance) {
		super(instance, 68);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure DunZirconchipright!");
			return;
		}
