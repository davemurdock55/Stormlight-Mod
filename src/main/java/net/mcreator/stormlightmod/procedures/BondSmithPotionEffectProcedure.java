...
public class BondSmithPotionEffectProcedure extends StormlightModModElements.ModElement {
	public BondSmithPotionEffectProcedure(StormlightModModElements instance) {
		super(instance, 195);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure BondSmithPotionEffect!");
			return;
		}
