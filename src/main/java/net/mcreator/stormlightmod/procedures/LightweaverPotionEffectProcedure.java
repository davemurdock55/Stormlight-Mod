...
public class LightweaverPotionEffectProcedure extends StormlightModModElements.ModElement {
	public LightweaverPotionEffectProcedure(StormlightModModElements instance) {
		super(instance, 191);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure LightweaverPotionEffect!");
			return;
		}
