...
public class CultivationSprenRightClickProcedure extends StormlightModModElements.ModElement {
	public CultivationSprenRightClickProcedure(StormlightModModElements instance) {
		super(instance, 238);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure CultivationSprenRightClick!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				System.err.println("Failed to load dependency sourceentity for procedure CultivationSprenRightClick!");
			return;
		}
