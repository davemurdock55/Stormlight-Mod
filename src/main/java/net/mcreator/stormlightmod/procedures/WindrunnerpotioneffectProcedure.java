...
public class WindrunnerpotioneffectProcedure extends StormlightModModElements.ModElement {
	public WindrunnerpotioneffectProcedure(StormlightModModElements instance) {
		super(instance, 157);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Windrunnerpotioneffect!");
			return;
		}
