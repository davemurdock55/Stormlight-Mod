...
public class CultivationSprenspawningProcedure extends StormlightModModElements.ModElement {
	public CultivationSprenspawningProcedure(StormlightModModElements instance) {
		super(instance, 309);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure CultivationSprenspawning!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure CultivationSprenspawning!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure CultivationSprenspawning!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure CultivationSprenspawning!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure CultivationSprenspawning!");
			return;
		}
		...
		if (world instanceof World && !world.getWorld().isRemote) {
			Entity entityToSpawn = new CultivationSprenEntity.CustomEntity(CultivationSprenEntity.entity, world.getWorld());
