...
public class TruthwatcherSprenrightProcedure extends StormlightModModElements.ModElement {
	public TruthwatcherSprenrightProcedure(StormlightModModElements instance) {
		super(instance, 232);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure TruthwatcherSprenright!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				System.err.println("Failed to load dependency sourceentity for procedure TruthwatcherSprenright!");
			return;
		}
