...
public class CultivationsprenguiOnKeyPressedProcedure extends StormlightModModElements.ModElement {
	public CultivationsprenguiOnKeyPressedProcedure(StormlightModModElements instance) {
		super(instance, 310);
	}
