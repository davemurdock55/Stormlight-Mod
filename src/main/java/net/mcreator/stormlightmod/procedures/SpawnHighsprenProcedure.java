...
public class SpawnHighsprenProcedure extends StormlightModModElements.ModElement {
	public SpawnHighsprenProcedure(StormlightModModElements instance) {
		super(instance, 306);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (world instanceof World && !world.getWorld().isRemote) {
			Entity entityToSpawn = new HighSprenEntity.CustomEntity(HighSprenEntity.entity, world.getWorld());
