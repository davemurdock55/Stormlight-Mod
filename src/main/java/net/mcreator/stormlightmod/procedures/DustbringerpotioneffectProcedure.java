...
public class DustbringerpotioneffectProcedure extends StormlightModModElements.ModElement {
	public DustbringerpotioneffectProcedure(StormlightModModElements instance) {
		super(instance, 188);
	}
