...
public class LashingAmount2KeyBinding extends StormlightModModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;
	public LashingAmount2KeyBinding(StormlightModModElements instance) {
		super(instance, 129);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.lashing_amount_2", GLFW.GLFW_KEY_2, "key.categories.misc");
		...
		if (type == 1) {
			{
				...
				LashingAmplifier2Procedure.executeProcedure($_dependencies);
			}
		}
	}
}
