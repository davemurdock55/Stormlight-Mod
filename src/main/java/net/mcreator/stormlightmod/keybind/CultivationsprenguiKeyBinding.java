...
public class CultivationsprenguiKeyBinding extends StormlightModModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public CultivationsprenguiKeyBinding(StormlightModModElements instance) {
		super(instance, 310);
		...
		if (type == 0) {
			{
				...
				CultivationsprenguiOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
